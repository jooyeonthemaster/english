...
@media (max-width: 1023.98px) {
  .par-edit-chrome, .par-egrip2, .par-eblock-del, .par-edit-hcell, .par-eresize, .par-page-controls, .par-cov-logo-resize, .par-edit-del, .par-edit-add, .par-vocab-study-card-del { display: none !important; }
