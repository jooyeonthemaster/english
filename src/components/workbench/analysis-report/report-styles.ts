...
.par-title .par-title-en {
  ...
  color: var(--ink-on-fill-muted, #d7def0); margin-top: 2mm;
}
...
.par-step-no { flex: 0 0 auto; width: 7mm; height: 7mm; border-radius: 50%; background: var(--ink-fill, var(--ink)); color: var(--ink-on-fill, #fff); border: .3mm solid var(--ink); font-weight: 800; font-size: 9pt; display: flex; align-items: center; justify-content: center; }
...
.par-core .par-core-detail { font-size: 8pt; color: var(--ink-on-fill-muted, #cdd5e6); }
