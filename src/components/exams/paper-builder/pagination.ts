...
import { BLOCK_PX_PER_PT, LINE_GAP_MAX_PX, isLineGapItem } from "./types";
...
function boxLineHeight(settings: PaginationSettings, fontPx?: number): number {
  const fontSize = fontPx ?? densityFontPx(settings);
