...
export const CH3_STEPS: TourStepDef[] = [
  ...
  },
  {
    ...
    chapter: "worksheet",
    view: "passages",
    // [F3 26-08-31] reading 「직독직해 분석본」 합류로 4상품 — 자구 정본 spec.md §2
    // CH3(v1.2 개정)을 먼저 고치고 여기를 동기화했다(자구 변형 금지 계약 유지).
    title: "네 가지 구성 중에 고릅니다",
    body: "기본 학습지는 원문 분석·어법·어휘·구문까지 담은 표준 구성입니다. 실전 학습지 포함은 여기에 워크북과 수능형 추론 5문항을 더합니다. 파이널 원페이지는 시험 직전용 요약 한 장입니다. 직독직해 분석본은 문장마다 슬래시로 끊어 읽고 1:1 해석을 나란히 담습니다. 구성마다 지문당 차감되는 크레딧이 함께 표시되어 비용을 미리 알 수 있습니다. 아래에서 눌러 보며 비교해 보세요.",
