...
export const CH5_STEPS: TourStepDef[] = [
  ...
  },
  {
    ...
    // [E28] 세그먼트 탭 [전체·문제·학습지] 이 삭제되고 목록이 **지문 카드**가 됐다
    // (§3.10.27). 옛 문구는 없어진 UI 를 가리키고 있었다 — 정본 .tmp-studio-tour/spec.md:157
    // 도 함께 개정했다(자구 일치 유지).
    body: "지문마다 카드 한 장입니다. 카드를 펼치면 그 지문의 학습지와 문제가 함께 나오고, 담은 지문은 맨 위로 올라옵니다.",
    placement: "right",
  },
  {
    id: "ch5-filter",
