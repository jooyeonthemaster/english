...
import { calendarEventSchema, messageSchema } from "@/lib/validations";
import { revalidatePath } from "next/cache";

// 학원 내부 공지(Notice) CRUD 는 플랫폼 공지로 교체되어 제거되었습니다.
// 관련 액션: src/actions/admin-announcements(발행) · platform-announcements(조회).
