...
const CONTENT: FeaturePageContent = {
  ...
  subhead:
    "스모트(SMOAT)는 영어 지문 분석, 내신·수능 19유형 AI 영어 문제 생성, Word 시험지 자동 제작, 그리고 학원 운영까지 한곳에서 끝내는 영어학원 AI 올인원 서비스입니다. 영어 강사가 자료 제작에 쓰던 시간을 수업에 돌려드립니다.",
  heroBullets: [
    "AI 영어 문제 생성 · 지문 분석 · 시험지 제작 올인원",
    "내신·수능·EBS·모의고사 19유형 자동 출제",
  ...
  sections: [
    {
      ...
      body: "스모트는 영어학원과 영어 강사를 위한 AI 올인원 플랫폼입니다. 지문 하나를 넣으면 직독직해·구문·어휘 분석부터 내신 19유형 변형문제 생성, 정답·해설지 작성, Word 시험지 자동 조판까지 한 번에 이어집니다. 흩어진 여러 도구 대신, 자료 제작의 처음부터 끝까지를 스모트 하나로 해결합니다.",
      bullets: [
        "영어 지문 분석 — 직독직해·논리구조·어휘·구문",
        "AI 영어 문제 생성 — 내신·수능 19유형",
  ...
  ctaBody:
    "영어 지문 분석부터 19유형 문제 생성, Word 시험지·해설지까지 — 스모트 하나로 끝냅니다. 회원가입 후 실제 자료를 바로 만들어 보세요.",
  related: [
    {
      href: "/features/ai-question-generation",
      label: "AI 영어 문제 생성",
      description: "지문 하나로 내신 19유형 변형문제를 자동 생성",
    },
    {
