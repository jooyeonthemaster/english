...
## 사용 가능한 유형
객관식: BLANK_INFERENCE, GRAMMAR_ERROR, GRAMMAR_CHOICE_COMBO, VOCAB_CHOICE, SENTENCE_ORDER, SENTENCE_INSERT, TOPIC, MAIN_IDEA, TOPIC_MAIN_IDEA, TITLE, IMPLIED_MEANING, REFERENCE, CONTENT_MATCH, SUMMARY_COMPLETE_MC, IRRELEVANT
서술형: CONDITIONAL_WRITING, SENTENCE_TRANSFORM, FILL_BLANK_KEY, SUMMARY_COMPLETE, SUMMARY_WRITING, WORD_ORDER, TOPIC_SENTENCE_WRITING, GRAMMAR_CORRECTION
