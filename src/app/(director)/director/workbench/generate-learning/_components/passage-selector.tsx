      ...
      <div className="bg-white rounded-2xl border p-6 space-y-4">
        <div className="flex items-center gap-2">
          ...
          <button
            ...
            className="h-11 px-4 text-[13px] font-semibold rounded-xl bg-blue-600 text-white hover:bg-blue-700 transition-colors flex items-center gap-1.5 shrink-0"
          >
  ...
  return (
    <div className="bg-white rounded-2xl border border-slate-200 p-6 space-y-4">
      ...
      <input
        ...
        className="w-full h-10 px-3 text-[13px] rounded-lg border border-slate-200 outline-none focus:border-blue-400"
      />
      ...
      <div className="flex gap-3">
        ...
        <input
          ...
          className="flex-1 h-10 px-3 text-[13px] rounded-lg border border-slate-200 outline-none focus:border-blue-400"
        />
      </div>
      ...
      <textarea
        ...
        className="w-full min-h-[160px] px-3 py-2 text-[13px] leading-relaxed rounded-lg border border-slate-200 bg-slate-50/60 outline-none focus:border-blue-400 resize-none font-mono"
      />
      ...
      <div className="flex justify-end">
        <button
          ...
          className="h-10 px-5 text-[13px] font-semibold rounded-lg bg-blue-600 text-white hover:bg-blue-700 disabled:opacity-50 transition-colors flex items-center gap-1.5"
        >
          {saving ? (
    ...
    <div className="space-y-1.5">
      {passages.map((p) => (
        <button
          key={p.id}
          onClick={() => onSelect(p)}
          className="group w-full rounded-xl border border-transparent px-4 py-3 text-left transition-all hover:border-slate-200 hover:bg-slate-50"
        >
          <div className="flex items-center gap-2">
            <FileText className="w-4 h-4 text-slate-300 shrink-0" />
            <span className="flex-1 truncate text-[13px] font-semibold text-slate-800 transition-colors group-hover:text-slate-900">
              {p.title}
            </span>
