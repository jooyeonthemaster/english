          ...
          <>
            <div className="border-b border-slate-200 px-5 py-3">
              <input
                ...
                className="w-full border-none bg-transparent text-[14px] font-bold text-slate-800 outline-none"
              />
            </div>
            <div className="flex-1 overflow-hidden">
              <textarea
                ...
                className="h-full w-full resize-none border-none bg-white px-5 py-4 text-[13px] leading-relaxed text-slate-800 outline-none"
                spellCheck={false}
              />
            </div>
            <div className="flex items-center justify-end gap-2 border-t border-slate-200 bg-slate-50/60 px-5 py-3">
              <button
                onClick={onDelete}
                className="flex items-center gap-1 rounded-lg px-2.5 py-1.5 text-[12px] font-medium text-rose-600 hover:bg-rose-50"
              >
