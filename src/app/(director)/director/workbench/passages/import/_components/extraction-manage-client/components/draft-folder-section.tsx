...
export function DraftFolderSection({
  ...
  return (
    <section className="overflow-hidden rounded-2xl border border-slate-200 bg-white shadow-sm">
      ...
      {!collapsed ? (
        <div className="relative flex items-center justify-end px-4 pb-2 pt-0.5">
          <div
            ...
            className="group/vhandle absolute left-1/2 top-1/2 inline-flex h-5 w-[200px] -translate-x-1/2 -translate-y-1/2 cursor-row-resize items-center justify-center px-1 select-none"
          >
