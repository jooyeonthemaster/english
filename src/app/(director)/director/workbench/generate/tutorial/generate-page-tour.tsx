...
const DIRECT_TOUR_STEPS: TourStep[] = [
  ...
  },
  {
    ...
    body: "생성/검수 결과에서 방금 만든 2문제만 강조해두었습니다. 그중 첫 번째 문제 카드를 클릭해 상세보기를 열어주세요.",
    video: "results",
    ...
    required: {
      ...
      waitingLabel: "강조된 첫 번째 문제 카드를 클릭해 상세보기를 열어주세요.",
...
const FILE_TOUR_STEPS: TourStep[] = [
  ...
  },
  {
    ...
    body: "생성/검수 결과에서 이미지·PDF 추출 지문으로 방금 만든 문제 카드를 강조해두었습니다. 강조된 카드를 클릭해 상세보기를 열어주세요.",
    video: "results",
    targets: ["generated-question-card-first", "results-section"],
    glowTargets: ["generated-question-card-first"],
    ...
    required: {
      milestone: "question-detail-opened",
      waitingLabel: "강조된 문제 카드를 클릭해 상세보기를 열어주세요.",
...
const LEARNING_MATERIALS_TOUR_STEPS: TourStep[] = [
  ...
  },
  {
    ...
    body: "방금 학습자료가 생성된 지문 카드가 강조됩니다. 카드를 클릭하면 분석 포인트, 어휘, 독해 포인트를 확인할 수 있는 상세보기 팝업이 열립니다.",
    video: "library",
    ...
    required: {
      ...
      waitingLabel: "강조된 지문 카드를 클릭해 상세보기 팝업을 열어주세요.",
...
const WORKSPACE_EDIT_TOUR_STEPS: TourStep[] = [
  ...
  },
  {
    ...
    body: "방금 생성된 문제 카드가 생성/검수 결과에 표시됩니다. 강조된 첫 번째 문제 카드를 클릭해 상세보기를 열어주세요.",
    video: "workspace",
    targets: ["generated-question-card-first", "results-section"],
    glowTargets: ["generated-question-card-first"],
    resultHighlightCount: 1,
...
export function GeneratePageTour({
  ...
  useEffect(() => {
    const id = window.requestAnimationFrame(() => {
      const hidden = window.localStorage.getItem(TOUR_HIDDEN_KEY) === "1";
      setVisible(!hidden);
    });
