...
// 기존 원장 대시보드는 제거됨. 26-08-22 로그인 후 진입점을 「클래스 스튜디오」
// (/director/studio)로 옮겼다 — 문제 생성 페이지가 아니라 스튜디오가 홈이다.
//
...
// 만약 제거되더라도 최소한 동작(클래스 스튜디오로 이동)은 유지하도록 폴백으로 남겨둔다.
export default function DirectorHomePage() {
  redirect("/director/studio");
}
