...
import { CheckCircle2, PackageX, Sparkles, Zap } from "lucide-react";
import {
  CREDIT_COSTS,
  OPERATION_LABELS,
  type OperationType,
...
export const metadata: Metadata = {
  title: "SMOAT 크레딧 상품 정보 | SMOAT",
  description:
    "SMOAT 크레딧 상품 가격, 사용 가능 기능, 기능별 차감 크레딧, 지급 및 배송 정책을 안내합니다.",
};
      ...
      <div className="mx-auto max-w-6xl px-5 py-10 sm:px-8 sm:py-14">
        ...
        <section className="rounded-2xl border border-slate-200 bg-white p-6 shadow-sm sm:p-8">
          ...
          <p className="mt-4 max-w-3xl text-[15px] leading-7 text-slate-600">
            SMOAT 크레딧은 문제 생성, 자동 출제, 지문 분석, OCR, 해설 생성 등
            SMOAT 내부 AI 기능을 이용하기 위한 디지털 서비스 이용권입니다.
            실물 배송은 없으며, 결제 승인 또는 가상계좌 입금 확인 후 서비스
            잔고에 즉시 지급됩니다. 구매 상품별 1C의 원화 단가는 다를 수
            있지만, 동일한 AI 기능을 실행할 때 차감되는 크레딧 수는 동일하게
            적용됩니다.
          </p>
          <div className="mt-6 grid grid-cols-1 gap-3 sm:grid-cols-3">
            <ProductNotice
              ...
              title="디지털 이용권"
              body="SMOAT 서비스 내부 AI 기능 이용에만 사용할 수 있습니다."
            />
            <ProductNotice
              icon={<Zap className="size-4" strokeWidth={2} />}
              title="즉시 지급"
              body="결제 승인 확인 후 학원 계정의 크레딧 잔고에 반영됩니다."
            />
            <ProductNotice
