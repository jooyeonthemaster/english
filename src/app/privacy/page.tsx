...
const PRIVACY_SECTIONS = [
  ...
  },
  {
    ...
    body: [
      ...
      "결제 정보: 결제금액, 결제수단, 결제일시, 주문명, 구독 이용 기간 및 다음 갱신일, 포트원 결제 ID, PG 거래 ID, 결제 상태, 영수증 URL, 취소·환불 내역",
      ...
      <div className="mx-auto max-w-5xl px-5 py-10 sm:px-8 sm:py-14">
        ...
        <section className="rounded-2xl border border-slate-200 bg-white p-6 shadow-sm sm:p-8">
          ...
          <p className="mt-4 max-w-3xl text-[15px] leading-7 text-slate-600">
            본 방침은 SMOAT가 서비스 제공, 구독 및 크레딧 결제, 환불 처리,
            고객지원 과정에서 개인정보를 어떻게 처리하고 보호하는지
            안내합니다.
          </p>
        ...
        <section className="mt-5 grid grid-cols-1 gap-4 md:grid-cols-3">
          ...
          <SummaryCard title="보관 기준" body="목적 달성 후 파기 또는 법정 기간 보관" />
        </section>
        ...
        <section className="mt-5 rounded-2xl border border-blue-100 bg-blue-50 p-5 text-[13px] leading-6 text-blue-900">
          ...
          <p className="mt-2">
            ...
            KCP를 통해 구독·크레딧 결제 승인·취소·환불 상태를 확인합니다.
