...
export async function GET() {
  const lines: string[] = [
    `# 스모트 (SMOAT)`,
    ``,
    `> 스모트(SMOAT)는 한국 영어학원을 위한 AI 올인원 서비스입니다. 영어 지문 분석(직독직해·구문·어휘 A4 분석지), 내신·수능 19유형 AI 영어 문제 생성(빈칸추론·어법·순서·삽입·서술형 등), 편집 가능한 Word(.docx)·한글 시험지 자동 조판, 학원 운영(ERP)까지 한곳에서 제공합니다. 주식회사 네안데르가 운영합니다.`,
    ``,
