...
const CONTENT: FeaturePageContent = {
  ...
  subhead:
    "지문 하나만 넣으면 빈칸·어법·순서·삽입·요지·서술형까지, 내신 19유형 변형문제가 1초 만에 만들어집니다. 강사가 마킹한 출제 포인트를 그대로 반영해 실제 시험에 직결되는 고퀄 문항을 생성합니다.",
  heroBullets: [
  ...
  faq: [
    ...
    },
    {
      ...
      answer:
        "회원가입 후 무료로 문제 생성을 체험할 수 있습니다. 이후에는 기능별 크레딧 또는 구독으로 이용하며, 자세한 가격은 상품·요금 페이지에서 확인할 수 있습니다.",
    },
  ],
  ctaTitle: "영어 문제 만들기, 오늘 30분을 5분으로",
  ctaBody:
    "지문 분석부터 19유형 출제, Word 시험지·해설지까지 — SMOAT 하나로 끝냅니다. 지금 무료로 사용해 보세요.",
  related: [
    {
