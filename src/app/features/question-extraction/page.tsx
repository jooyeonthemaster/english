...
const CONTENT: FeaturePageContent = {
  ...
  sections: [
    ...
    },
    {
      ...
      body: "검수를 마친 문항은 지문과 함께 문제은행에 저장됩니다. 저장된 문항은 Word·한글 시험지 조판에 바로 배치하거나, 같은 지문으로 24유형 변형 문항을 새로 출제하는 재료가 됩니다. 종이 문제집에 잠자던 자료가 반복 활용되는 자산으로 바뀝니다.",
      bullets: [
        "지문과 함께 문제은행에 저장",
        "시험지 조판에 바로 배치",
        "같은 지문으로 변형 문항 출제",
  ...
  faq: [
    ...
    },
    {
      ...
      answer:
        "지문과 함께 문제은행에 저장되어 Word·한글 시험지 조판에 바로 배치하거나, 같은 지문으로 24유형 변형 문항을 출제하는 재료로 씁니다. 지문 분석 학습지·웹툰 생성에도 같은 지문을 활용할 수 있습니다.",
    },
  ],
