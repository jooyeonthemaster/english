...
const CONTENT: FeaturePageContent = {
  ...
  sections: [
    {
      ...
      body: "생성하거나 보유한 영어 문항을 편집 가능한 Word(.docx) 시험지로 자동 조판해 내려받습니다. 객관식부터 서술형까지 내신·수능 24유형을 시험지에 그대로 배치하니, 받은 파일에서 발문이나 배점을 바로 손봐 학원 시험에 사용할 수 있습니다. 한글(HWPX) 내보내기와 PDF 다운로드도 지원합니다.",
      bullets: [
        "객관식~서술형 내신·수능 24유형 그대로 조판",
        "편집 가능한 Word(.docx)로 발문·배점 바로 수정",
        "한글(HWPX) 내보내기 지원 · PDF 다운로드 메뉴",
      ],
    },
    {
    ...
    },
    {
      ...
      body: "화면에서 본 미리보기와 내려받은 시험지가 픽셀 단위로 동일합니다. 줄간격·자간·여백·폰트를 1:1로 맞춰 조판하므로, 미리보기에서 본 그대로 인쇄됩니다. 글꼴은 맑은 고딕으로 통일해 Word는 픽셀 단위로 일치하고, 한글(HWPX)도 같은 조판을 그대로 옮겨 내보냅니다.",
      bullets: [
        "줄간격·자간·여백·폰트 1:1 시험지 자동 조판",
        "맑은 고딕 통일로 학원 PC 인쇄 호환",
        "PDF·Word는 미리보기와 1:1, 한글(HWPX) 내보내기 지원",
      ],
    },
    {
  ...
  faq: [
    ...
    },
    {
      ...
      answer:
        "한글(HWPX) 내보내기를 지원합니다. 시험지 끝에는 정답표가 자동으로 생성되며, 정답이 길면 번호 목록형으로 자동 전환됩니다. Word 시험지·해설지도 같은 메뉴에서 함께 내려받을 수 있습니다.",
    },
    {
