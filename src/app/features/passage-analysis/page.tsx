...
const CONTENT: FeaturePageContent = {
  ...
  heroHighlight: "지문 하나가 한 장의 수업용 학습지가 됩니다",
  heroImage: {
    src: "/features/shots/passage-analysis/hero.png",
    alt: "SMOAT 영어 지문 분석 학습지 화면",
    caption: "지문 분석 학습지",
  },
  heroStats: [
    { value: "7", unit: "개", label: "심층 분석 섹션" },
    { value: "11", unit: "가지", label: "학습 활동" },
    { value: "6", unit: "가지", label: "지문 변형" },
  ],
  heroBullets: [
    "지문 하나를 7개 섹션 A4 분석 보고서로",
    "문장별 직독직해 + 의미 단위 끊어읽기",
    "엄선 핵심 어휘 14~20개 정리 + 구문 분석",
    "5가지 템플릿·색상 테마 + PDF 출력(인쇄)으로 배포",
  ],
  sectionsTitle: "분석부터 배포까지 한 흐름",
  sectionsBody: "직독직해·구문·어휘를 강사가 감수해 PDF로 배포합니다.",
  sections: [
    {
      title: "직독직해·논리 구조까지 — 7개 섹션 심층 분석지",
      image: {
        src: "/features/shots/passage-analysis/s1.png",
        alt: "직독직해와 논리 구조 분석 화면",
        caption: "심층 분석지",
      },
    ...
    },
    {
      ...
      image: {
        src: "/features/shots/passage-analysis/s2.png",
        alt: "구문·문법 포인트·어휘 정리 화면",
        caption: "구문·어휘",
      },
      body: "복잡한 문장을 분해해 해석하는 영어 구문 분석, 함정 오답 예문까지 곁들인 문법·구문 포인트, 빈칸·주제·제목·순서·삽입·함축·지칭·요약 등 유형별 출제 포인트와 전략을 한 장에 담습니다. 엄선한 핵심 어휘 14~20개는 발음·뜻·난이도·동의어/반의어와 함께 정리되어 영어 어휘 정리가 자동으로 끝납니다.",
      bullets: [
        "복잡한 문장 분해 + 해석으로 영어 구문 분석",
        "함정 오답 예문이 있는 문법·구문 포인트",
        "발음·뜻·난이도·동의어/반의어 엄선 어휘 14~20개",
      ],
    },
    {
      title: "11가지 학습 활동 + 6가지 지문 변형",
      image: {
        src: "/features/shots/passage-analysis/s3.png",
        alt: "학습 활동 구성 화면",
        caption: "학습 활동",
      },
    ...
    },
    {
      ...
      image: {
        src: "/features/shots/passage-analysis/s4.png",
        alt: "학습지 문서 미리보기 화면",
        caption: "PDF 미리보기",
      },
  ...
  faq: [
    {
      ...
      answer:
        "지문 하나를 7개 섹션 A4 분석지로 만듭니다. 문장별 직독직해와 끊어읽기, 논리 구조 분석, 핵심 요약과 영문 주제문, 문법·구문 포인트, 유형별 출제 포인트, 엄선 핵심 어휘 14~20개 정리, 복잡한 문장을 분해하는 구문 분석까지 담깁니다.",
    },
    {
