...
const CONTENT: FeaturePageContent = {
  ...
  subhead:
    "지문 텍스트를 넣으면 직독직해, 논리 구조 분석, 핵심 어휘 정리, 구문 분석까지 담은 7개 섹션 A4 심층 분석지가 자동으로 만들어집니다. 노베이스 학생도 이해하도록 용어를 바로 정의하고 존댓말로 통일한, 학원이 바로 배포할 수 있는 영어 내신 학습지입니다.",
  heroBullets: [
  ...
  related: [
    {
      ...
      label: "AI 영어 문제 생성",
      description: "분석한 지문으로 25유형 변형문제 자동 출제",
    },
    {
