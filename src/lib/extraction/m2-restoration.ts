...
export function buildRestorationPrompts(input: BuildRestorationPromptInput): {
  ...
  return {
    ...
    userPrompt: [
      ...
      "- For ordering questions with labeled chunks like (A), (B), (C), use the linked question stem and choices to infer the best supported original order. Remove the chunk labels in restoredText.",
