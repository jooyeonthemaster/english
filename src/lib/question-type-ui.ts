...
export const QUESTION_TYPE_UI: Record<string, QuestionTypeUiMeta> = {
  ...
  SUMMARY_WRITING: {
    ...
    label: "요약문 영작",
    category: "내신 서술형",
    description: "지문 요약문의 빈칸을 [보기]·해석·단서를 활용해 영어로 직접 영작하게 합니다. (배열 영작과 달리 한 빈칸에 다단어 어구 전체가 들어갑니다.)",
    studentTask: "요약문의 (A)/(B) 빈칸에 들어갈 영어 어구를 직접 영작합니다.",
    bestFor: ["글 전체 요약", "어순·통사 운용", "암기 무력화 서술형"],
    outputUi: ["해석 박스(선택)", "빈칸 요약문", "보기 칩(선택)", "앞글자 단서(선택)", "모범답안+동치답+채점기준"],
    requiredFields: ["summaryWithBlanks", "blanks", "modelAnswer"],
  },
  WORD_ORDER: {
    id: "WORD_ORDER",
    label: "배열 영작",
  ...
  TOPIC_SENTENCE_WRITING: {
    id: "TOPIC_SENTENCE_WRITING",
    label: "주제문 영작",
    category: "내신 서술형",
    description: "글의 주제를 주제문(12~14단어) 또는 명사구(≤12단어)로 만들어 제시어 배열 또는 빈칸 완성으로 영작하게 합니다.",
    studentTask: "제시어를 배열하거나 [보기]를 활용해 글의 주제문을 완성합니다.",
    bestFor: ["내신 킬러 서술형", "주제 파악+영작", "외부지문 대비"],
    outputUi: ["주제 힌트(선택)", "제시어 칩/빈칸 주제문", "보기 칩", "모범답안+채점기준"],
    requiredFields: ["mode", "modelAnswer"],
  },
  GRAMMAR_CORRECTION: {
...
export const QUESTION_TYPE_GROUPS = [
  ...
  },
  {
    ...
    items: [
      ...
      QUESTION_TYPE_UI.SUMMARY_WRITING,
      QUESTION_TYPE_UI.WORD_ORDER,
      QUESTION_TYPE_UI.TOPIC_SENTENCE_WRITING,
