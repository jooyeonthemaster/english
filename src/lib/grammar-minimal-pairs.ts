...
export const GRAMMAR_MINIMAL_PAIRS: Record<string, GrammarMinimalPair[]> = {
  ...
  m: [{ correct: "much", wrong: "very", count: 8 }, { correct: "few", wrong: "little", count: 5 }, { correct: "much", wrong: "many", count: 4 }, { correct: "most", wrong: "almost", count: 3 }, { correct: "than", wrong: "as", count: 3 }],
};
