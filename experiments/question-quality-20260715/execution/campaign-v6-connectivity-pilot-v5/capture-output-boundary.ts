...
import { assertExactMetadataEnvironmentV5 } from "./live-environment";

export function assertExactMetadataCaptureEnvironmentV5(env: NodeJS.ProcessEnv = process.env): void {
...
export function parsePriceCaptureCliArgumentsV5(args: readonly string[]): { outputPath: string } {
...
export function assertCanonicalDirectPrivateOutputV5(rawPath: string, privateRoot: string): string {
