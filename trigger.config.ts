    ...
    extensions: [
      ...
      syncEnvVars(async () => {
        const keys = [
          "DATABASE_URL",
          "DIRECT_URL",
          "ATLASCLOUD_TEXT_API_KEY",
          "ATLASCLOUD_TEXT_BASE_URL",
          "ATLASCLOUD_FREE_MODEL",
          "ATLASCLOUD_STANDARD_MODEL",
          "ATLASCLOUD_PREMIUM_MODEL",
          "ATLASCLOUD_TEXT_MODEL",
          "ATLASCLOUD_OCR_MODEL",
          "ATLASCLOUD_RESTORATION_MODEL",
          "ATLASCLOUD_TRANSFORM_MODEL",
          "ATLASCLOUD_VARIANT_MODEL",
          "ATLASCLOUD_TUTOR_MODEL",
          "ATLASCLOUD_WEBTOON_DETECT_MODEL",
          ...
          "EXPLANATION_VERIFY_MIN_BUDGET_MS",
          ...
          "TRIGGER_SIMILAR_EXAM_QUEUE_NAME",
          ...
          "TRIGGER_SIMILAR_EXAM_PER_ACADEMY",
